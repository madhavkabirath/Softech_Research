...
export default function Contact() {
  ...
  return (
    <div className=" ">
      ...
      <Link href={"/Contact_Form"}><button className="text-white flex text-xl bg-green-400 rounded-md p-4  mx-4 ">
        <FaPlus className="mx-2 text-3xl" />
        Add New Contact Info
      </button></Link>

      <h1 className="mx-4 text-xl py-4">Contact List</h1>
        ...
        <table className=" w-full">
          <thead className=" bg-gray-300">
            <tr className="">
              ...
              <td className="px-2 border-2">Address Reference</td>
              <td className="px-2 border-2">Address</td>
              <td className="px-2 border-2">Working Title</td>
              <td className="px-2 border-2">Working hours</td>
              <td className="px-2 border-2">Img alt</td>
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-md">
            ...
            <p>Please confirm you would like to delete this Contact.</p>
